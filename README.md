...
- [v] Clone your OWN fork of the repository using your terminal.
- [v] CD into the project base directory.
- [v] Download project dependencies by running `npm install`.
- [v] Start up the app using `npm start`.
- [v] Optionally run tests using `npm test`. (The app must be running on `http://localhost:1234`)
